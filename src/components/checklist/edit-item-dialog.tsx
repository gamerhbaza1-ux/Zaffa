...
export function EditItemDialog({ item, onOpenChange, onItemUpdated, categories }: EditItemDialogProps) {
  ...
  useEffect(() => {
    if (item) {
      ...
      setSuggestedModel(item.suggestedModel || '');
      setErrors({});
    }
  }, [item]);
        ...
        <form onSubmit={handleSubmit} className="space-y-6 pt-4">
            <div className="space-y-4">
                <div className="flex gap-4">
                    ...
                    <div className="w-24">
                      <Label htmlFor="edit-quantity">العدد</Label>
                      <Input id="edit-quantity" type="number" min="1" value={quantity} onChange={e => setQuantity(Number(e.target.value))} />
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <Label htmlFor='edit-minPrice'>أقل سعر (للقطعة)</Label>
                  ...
                  <div>
                    <Label htmlFor='edit-maxPrice'>أقصى سعر (للقطعة)</Label>
                ...
                <div>
                  <Label htmlFor="edit-suggestedModel">الموديل المقترح (اختياري)</Label>
                  <Input 
                    id="edit-suggestedModel" 
                    value={suggestedModel} 
                    onChange={e => setSuggestedModel(e.target.value)} 
                    placeholder="مثال: ال جي إنفرتر" 
                  />
                </div>
